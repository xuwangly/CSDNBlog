...
static int MPU6050_WriteCalibration(struct i2c_client *client, int dat[MPU6050_AXES_NUM])
{
	...
	cali[MPU6050_AXIS_X] = cali[MPU6050_AXIS_X] % 2048;
	cali[MPU6050_AXIS_Y] = cali[MPU6050_AXIS_Y] % 2048;
	cali[MPU6050_AXIS_Z] = cali[MPU6050_AXIS_Z] % 2048;

	//printk("[LOL] %d %d %d\n" , cali[MPU6050_AXIS_X] , cali[MPU6050_AXIS_Y] , cali[MPU6050_AXIS_Z]);
	if(cali[MPU6050_AXIS_X] > 1024)
		cali[MPU6050_AXIS_X] = cali[MPU6050_AXIS_X] - 2048;
	else if(cali[MPU6050_AXIS_X] <  -1024)
		cali[MPU6050_AXIS_X] = cali[MPU6050_AXIS_X] + 2048;

	if(cali[MPU6050_AXIS_Y] > 1024)
		cali[MPU6050_AXIS_Y] = cali[MPU6050_AXIS_Y] - 2048;
	else if(cali[MPU6050_AXIS_Y] <  -1024)
		cali[MPU6050_AXIS_Y] = cali[MPU6050_AXIS_Y] + 2048;

	if(cali[MPU6050_AXIS_Z] > 1024)
		cali[MPU6050_AXIS_Z] = cali[MPU6050_AXIS_Z] - 2048;
	else if(cali[MPU6050_AXIS_Z] <  -1024)
		cali[MPU6050_AXIS_Z] = cali[MPU6050_AXIS_Z] + 2048;
	//printk("[LOL] %d %d %d\n" , cali[MPU6050_AXIS_X] , cali[MPU6050_AXIS_Y] , cali[MPU6050_AXIS_Z]);
	//end add
